...
6. Note that "Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1)" is the same user agent string for all the 400 results, indicating that this was probably not the 
program used to download the file, but instead a directory bruteforcer (in this case, that of *dirb*)
